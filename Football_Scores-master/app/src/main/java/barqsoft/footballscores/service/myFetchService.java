...
public class myFetchService extends IntentService {
    ...
    private void getData(String timeFrame) {
        ...
        //Instantiate connection variables
        ...
        try {
            if (JSON_data != null) {
                ...
                JSONArray matches = json.getJSONArray("fixtures");
    ...
    private void processJSONdata(String JSONdata, Context mContext, boolean isReal) {
        ...
        try {
            ...
            Log.wtf(LOG_TAG, "Matches Length: " + matches.length());
            ...
            Log.e(LOG_TAG, "insert_data size: " + insert_data.length);
        ...
        Intent dataUpdatedIntent = new Intent(ScoresWidgetRemoteViewsService.ACTION_DATA_UPDATED)
